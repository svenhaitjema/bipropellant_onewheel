...
extern short current_driving_mode_gyro_bias;
...
void sensor_copy_buffer(SENSOR_DATA *s){
    ...
    if (copy) {
        ...
        //s->complete.Angle += current_driving_mode_gyro_bias;
        //s->complete.Angle_duplicate += current_driving_mode_gyro_bias;

        //s->complete.Angle = s->complete.Angle*4;
        //s->complete.Angle_duplicate = s->complete.Angle_duplicate*4;
